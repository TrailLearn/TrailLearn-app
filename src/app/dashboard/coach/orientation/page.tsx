...
export default function OrientationChatPage() {
  ...
  const getConvs = api.aiCoach.getConversations.useQuery({ type: "ORIENTATION" });
  ...
  return (
    <div className="container py-8 flex flex-col h-full max-h-screen">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold">Orientation Académique</h1>
          <p className="text-sm text-muted-foreground">Discussion avec votre Coach IA spécialisé</p>
        </div>
      </div>
